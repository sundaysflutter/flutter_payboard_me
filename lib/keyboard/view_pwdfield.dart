...
class CustomPwdField extends StatelessWidget {
  ...
  CustomPwdField(this.data, this.pwdLength, [this.charColor = Colors.black]);

  @override
  Widget build(BuildContext context) {
    return CustomPaint(
      painter: PwdField(data, pwdLength, charColor),
    );
  }
}
...
class PwdField extends CustomPainter {
  ...
  PwdField(this.data, this.pwdLength, this.charColor);
